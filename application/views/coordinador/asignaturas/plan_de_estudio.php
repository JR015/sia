...
<div class="modal modal-wide2 fade" id="modal-crear-asignatura" tabindex="-1" role="dialog" aria-labelledby="myModalLabel"
    ...
    <div class="modal-dialog">
        <div class="modal-content ">
            ...
            <form id="crear-asignatura" class="form-horizontal" method="post" action="<?= base_url('asignatura/crear') ?>"
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <label class="col-md-1 control-label" for="name">Area *</label>
                        <div class="col-md-3">
                            ...
                            <select required class="form-control" id="area" name="area" >
                                ...
                                <?php
                                    ...
                                    foreach ($areas as $area){
                                        ...
                                        echo '<option value="'.$area['codigo'].'">'.$area['nombre'].'</option>';
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-2">
                            ...
                            <input required autofocus id="horas-semanales" name="horas-semanales" type="number" min="1" class="form-control">
